...
// uint8, uint8
static SIMDPP_INL
uint8<16> i_bit_and(const uint8<16>& a, const uint8<16>& b)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint8<32> i_bit_and(const uint8<32>& a, const uint8<32>& b)
{
...
// uint8, mask_int8
static SIMDPP_INL
uint8<16> i_bit_and(const uint8<16>& a, const mask_int8<16>& b)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint8<32> i_bit_and(const uint8<32>& a, const mask_int8<32>& b)
{
...
// mask_int8, mask_int8
static SIMDPP_INL
mask_int8<16> i_bit_and(const mask_int8<16>& a, const mask_int8<16>& b)
{
#if SIMDPP_USE_NULL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
mask_int8<32> i_bit_and(const mask_int8<32>& a, const mask_int8<32>& b)
{
#if SIMDPP_USE_AVX512VL
    return a.native() & b.native();
#else
...
// uint16, uint16
static SIMDPP_INL
uint16<8> i_bit_and(const uint16<8>& a, const uint16<8>& b)
{
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint16<16> i_bit_and(const uint16<16>& a, const uint16<16>& b)
{
    return _mm256_and_si256(a.native(), b.native());
}
#endif
...
// uint16, mask_int16
static SIMDPP_INL
uint16<8> i_bit_and(const uint16<8>& a, const mask_int16<8>& b)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_and_vm(a, b);
#elif SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint16<16> i_bit_and(const uint16<16>& a, const mask_int16<16>& b)
{
#if SIMDPP_USE_AVX512VL
...
static SIMDPP_INL
mask_int16<8> i_bit_and(const mask_int16<8>& a, const mask_int16<8>& b)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_and_mm(a, b);
#elif SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
mask_int16<16> i_bit_and(const mask_int16<16>& a, const mask_int16<16>& b)
{
#if SIMDPP_USE_AVX512VL
    return a.native() & b.native();
#else
...
// uint32, uint32
static SIMDPP_INL
uint32<4> i_bit_and(const uint32<4>& a, const uint32<4>& b)
{
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint32<8> i_bit_and(const uint32<8>& a, const uint32<8>& b)
{
    return _mm256_and_si256(a.native(), b.native());
}
#endif
...
static SIMDPP_INL
uint32<16> i_bit_and(const uint32<16>& a, const uint32<16>& b)
{
...
// uint32, mask_int32
static SIMDPP_INL
uint32<4> i_bit_and(const uint32<4>& a, const mask_int32<4>& b)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_and_vm(a, b);
#elif SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint32<8> i_bit_and(const uint32<8>& a, const mask_int32<8>& b)
{
#if SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
uint32<16> i_bit_and(const uint32<16>& a, const mask_int32<16>& b)
{
...
static SIMDPP_INL
mask_int32<4> i_bit_and(const mask_int32<4>& a, const mask_int32<4>& b)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_and_mm(a, b);
#elif SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
mask_int32<8> i_bit_and(const mask_int32<8>& a, const mask_int32<8>& b)
{
#if SIMDPP_USE_AVX512VL
    return _mm512_kand(a.native(), b.native());
#else
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
mask_int32<16> i_bit_and(const mask_int32<16>& a, const mask_int32<16>& b)
{
    return _mm512_kand(a.native(), b.native());
}
#endif
...
// uint64, uint64
static SIMDPP_INL
uint64<2> i_bit_and(const uint64<2>& a, const uint64<2>& b)
{
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint64<4> i_bit_and(const uint64<4>& a, const uint64<4>& b)
{
    return _mm256_and_si256(a.native(), b.native());
}
#endif
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
uint64<8> i_bit_and(const uint64<8>& a, const uint64<8>& b)
{
...
// uint64, mask_int64
static SIMDPP_INL
uint64<2> i_bit_and(const uint64<2>& a, const mask_int64<2>& b)
{
#if SIMDPP_USE_NULL || (SIMDPP_USE_ALTIVEC && !SIMDPP_USE_VSX_207)
    return detail::null::bit_and_vm(a, b);
#elif SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
uint64<4> i_bit_and(const uint64<4>& a, const mask_int64<4>& b)
{
#if SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
uint64<8> i_bit_and(const uint64<8>& a, const mask_int64<8>& b)
{
...
static SIMDPP_INL
mask_int64<2> i_bit_and(const mask_int64<2>& a, const mask_int64<2>& b)
{
#if SIMDPP_USE_NULL || (SIMDPP_USE_ALTIVEC && !SIMDPP_USE_VSX_207)
    return detail::null::bit_and_mm(a, b);
#elif SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX2
static SIMDPP_INL
mask_int64<4> i_bit_and(const mask_int64<4>& a, const mask_int64<4>& b)
{
#if SIMDPP_USE_AVX512VL
    return _mm512_kand(a.native(), b.native());
#else
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
mask_int64<8> i_bit_and(const mask_int64<8>& a, const mask_int64<8>& b)
{
    return _mm512_kand(a.native(), b.native());
}
#endif
...
// float32, float32
static SIMDPP_INL
float32<4> i_bit_and(const float32<4>& a, const float32<4>& b)
{
...
#elif SIMDPP_USE_NEON
    return vreinterpretq_f32_u32(vandq_u32(vreinterpretq_u32_f32(a.native()),
...
#if SIMDPP_USE_AVX
static SIMDPP_INL
float32<8> i_bit_and(const float32<8>& a, const float32<8>& b)
{
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
float32<16> i_bit_and(const float32<16>& a, const float32<16>& b)
{
...
static SIMDPP_INL
float32<4> i_bit_and(const float32<4>& a, const mask_float32<4>& b)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_and_vm(a, b);
#elif SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX
static SIMDPP_INL
float32<8> i_bit_and(const float32<8>& a, const mask_float32<8>& b)
{
#if SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
float32<16> i_bit_and(const float32<16>& a, const mask_float32<16>& b)
{
...
static SIMDPP_INL
mask_float32<4> i_bit_and(const mask_float32<4>& a, const mask_float32<4>& b)
{
#if SIMDPP_USE_NULL || SIMDPP_USE_NEON_NO_FLT_SP
    return detail::null::bit_and_mm(a, b);
#elif SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX
static SIMDPP_INL
mask_float32<8> i_bit_and(const mask_float32<8>& a, const mask_float32<8>& b)
{
#if SIMDPP_USE_AVX512VL
    return _mm512_kand(a.native(), b.native());
#else
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
mask_float32<16> i_bit_and(const mask_float32<16>& a, const mask_float32<16>& b)
{
    return _mm512_kand(a.native(), b.native());
}
#endif
...
// float64, float64
static SIMDPP_INL
float64<2> i_bit_and(const float64<2>& a, const float64<2>& b)
{
#if SIMDPP_USE_SSE2
    return _mm_and_pd(a.native(), b.native());
#elif SIMDPP_USE_NEON64
    return vreinterpretq_f64_u64(vandq_u64(vreinterpretq_u64_f64(a.native()),
...
#if SIMDPP_USE_AVX
static SIMDPP_INL
float64<4> i_bit_and(const float64<4>& a, const float64<4>& b)
{
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
float64<8> i_bit_and(const float64<8>& a, const float64<8>& b)
{
#if SIMDPP_USE_AVX512DQ
...
static SIMDPP_INL
float64<2> i_bit_and(const float64<2>& a, const mask_float64<2>& b)
{
#if SIMDPP_USE_NULL
    return detail::null::bit_and_vm(a, b);
#elif SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX
static SIMDPP_INL
float64<4> i_bit_and(const float64<4>& a, const mask_float64<4>& b)
{
#if SIMDPP_USE_AVX512VL
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
float64<8> i_bit_and(const float64<8>& a, const mask_float64<8>& b)
{
...
static SIMDPP_INL
mask_float64<2> i_bit_and(const mask_float64<2>& a, const mask_float64<2>& b)
{
...
#if SIMDPP_USE_AVX
static SIMDPP_INL
mask_float64<4> i_bit_and(const mask_float64<4>& a, const mask_float64<4>& b)
{
#if SIMDPP_USE_AVX512VL
    return _mm512_kand(a.native(), b.native());
#else
...
#if SIMDPP_USE_AVX512F
static SIMDPP_INL
mask_float64<8> i_bit_and(const mask_float64<8>& a, const mask_float64<8>& b)
{
    return _mm512_kand(a.native(), b.native());
}
#endif
