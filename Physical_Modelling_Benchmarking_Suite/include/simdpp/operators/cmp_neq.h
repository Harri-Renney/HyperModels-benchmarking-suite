...
#ifndef LIBSIMDPP_SIMDPP_CORE_CMP_NEQ_OPERATOR_H
#define LIBSIMDPP_SIMDPP_CORE_CMP_NEQ_OPERATOR_H
...
mask_int8<N,expr_empty> operator!=(const any_int8<N,V1>& a,
...
*/
template<unsigned N, class V1, class V2> SIMDPP_INL
mask_int16<N,expr_empty> operator!=(const any_int16<N,V1>& a,
...
*/
template<unsigned N, class V1, class V2> SIMDPP_INL
mask_int32<N,expr_empty> operator!=(const any_int32<N,V1>& a,
...
*/
template<unsigned N, class V1, class V2> SIMDPP_INL
mask_int64<N,expr_empty> operator!=(const any_int64<N,V1>& a,
...
*/
template<unsigned N, class V1, class V2> SIMDPP_INL
mask_float32<N,expr_empty> operator!=(const any_float32<N,V1>& a,
...
*/
template<unsigned N, class V1, class V2> SIMDPP_INL
mask_float64<N,expr_empty> operator!=(const any_float64<N,V1>& a,
